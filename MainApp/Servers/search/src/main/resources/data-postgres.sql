...
INSERT INTO search.vehicle( -- BMW X5 1
    ...
    VALUES (1, 1, 1, 1, 5, 2, 5, 1, 100000, true, 1, 4, 1, 45.2553823, 19.8317609, false, 1, -1); /*1*/
INSERT INTO search.vehicle( -- Mercedes CLA 220 2
    id, brand_id, model_id, category_id, transmission_id, fuel_id, seats, child_seats, mileage, cdw, pricelist_id, number_of_stars, number_of_reviews, location_latitude, location_longitude, deleted, owner_id, available_mileage)
    VALUES (2, 2, 4, 3, 4, 2, 4, 0, 130000, false, 2, 3, 1, 44.766226, 20.443431, false, 2, 2000); /*2*/
INSERT INTO search.vehicle( -- BMW Z8 3
    id, brand_id, model_id, category_id, transmission_id, fuel_id, seats, child_seats, mileage, cdw, pricelist_id, number_of_stars, number_of_reviews, location_latitude, location_longitude, deleted, owner_id, available_mileage)
    VALUES (3, 1, 3, 3, 1, 2, 2, 0, 90000, false, 3, 5, 1, 44.766226, 20.443431, false, 1, 7000); /*3*/
INSERT INTO search.vehicle( -- Mercedes SL 450 4
    id, brand_id, model_id, category_id, transmission_id, fuel_id, seats, child_seats, mileage, cdw, pricelist_id, number_of_stars, number_of_reviews, location_latitude, location_longitude, deleted, owner_id, available_mileage)
    VALUES (4, 2, 5, 3, 2, 1, 2, 0, 250000, true, 5, 2, 1, 44.766226, 20.443431, false, 2, -1); /*4*/
INSERT INTO search.vehicle( -- Mercedes GLS 550 5
    id, brand_id, model_id, category_id, transmission_id, fuel_id, seats, child_seats, mileage, cdw, pricelist_id, number_of_stars, number_of_reviews, location_latitude, location_longitude, deleted, owner_id, available_mileage)
    VALUES (5, 2, 6, 1, 4, 2, 5, 0, 120000, false, 2, 3, 1, 45.2553823, 19.8317609, false, 1, 4000); /*5*/
INSERT INTO search.vehicle( -- Alfa Romeo Giulia 6
    id, brand_id, model_id, category_id, transmission_id, fuel_id, seats, child_seats, mileage, cdw, pricelist_id, number_of_stars, number_of_reviews, location_latitude, location_longitude, deleted, owner_id, available_mileage)
    VALUES (6, 3, 7, 3, 2, 2, 4, 0, 135000, true, 5, 4, 1, 45.2553823, 19.8317609, false, 2, 9000); /*6*/
INSERT INTO search.vehicle( -- Alfa Romeo Stelvio 7
    id, brand_id, model_id, category_id, transmission_id, fuel_id, seats, child_seats, mileage, cdw, pricelist_id, number_of_stars, number_of_reviews, location_latitude, location_longitude, deleted, owner_id, available_mileage)
    VALUES (7, 3, 8, 1, 4, 2, 5, 1, 190000, true, 5, 4, 1, 45.2553823, 19.8317609, false, 1, -1); /*7*/
INSERT INTO search.vehicle( -- Mazda MX-5 8
    id, brand_id, model_id, category_id, transmission_id, fuel_id, seats, child_seats, mileage, cdw, pricelist_id, number_of_stars, number_of_reviews, location_latitude, location_longitude, deleted, owner_id, available_mileage)
    VALUES (8, 4, 9, 3, 1, 1, 2, 0, 200000, false, 3, 5, 1, 45.2553823, 19.8317609, false, 2, 15000); /*8*/
INSERT INTO search.vehicle( -- Mazda CX-5 9
    id, brand_id, model_id, category_id, transmission_id, fuel_id, seats, child_seats, mileage, cdw, pricelist_id, number_of_stars, number_of_reviews, location_latitude, location_longitude, deleted, owner_id, available_mileage)
    VALUES (9, 4, 10, 1, 4, 2, 5, 1, 210000, true, 5, 3, 1, 45.2553823, 19.8317609, false, 1, 12000); /*9*/
INSERT INTO search.vehicle( -- Toyota Prius 10
    id, brand_id, model_id, category_id, transmission_id, fuel_id, seats, child_seats, mileage, cdw, pricelist_id, number_of_stars, number_of_reviews, location_latitude, location_longitude, deleted, owner_id, available_mileage)
    VALUES (10, 5, 11, 2, 3, 3, 5, 1, 145000, false, 4, 5, 1, 45.2553823, 19.8317609, false, 2, -1); /*10*/
INSERT INTO search.vehicle( -- Toyota RAV-4 11
    id, brand_id, model_id, category_id, transmission_id, fuel_id, seats, child_seats, mileage, cdw, pricelist_id, number_of_stars, number_of_reviews, location_latitude, location_longitude, deleted, owner_id, available_mileage)
    VALUES (11, 5, 12, 1, 4, 1, 5, 0, 168000, true, 5, 4, 1, 45.2553823, 19.8317609, false, 1, 11000); /*11*/
INSERT INTO search.vehicle( -- Toyota Yaris 12
    id, brand_id, model_id, category_id, transmission_id, fuel_id, seats, child_seats, mileage, cdw, pricelist_id, number_of_stars, number_of_reviews, location_latitude, location_longitude, deleted, owner_id, available_mileage)
    VALUES (12, 5, 13, 2, 1, 1, 4, 1, 98000, false, 4, 5, 1, 45.2553823, 19.8317609, false, 2, 9500); /*12*/
INSERT INTO search.vehicle( -- Tesla Model S 13
    id, brand_id, model_id, category_id, transmission_id, fuel_id, seats, child_seats, mileage, cdw, pricelist_id, number_of_stars, number_of_reviews, location_latitude, location_longitude, deleted, owner_id, available_mileage)
    VALUES (13, 6, 14, 3, 4, 3, 4, 0, 196000, true, 5, 4, 1, 45.2553823, 19.8317609, false, 1, -1); /*13*/
