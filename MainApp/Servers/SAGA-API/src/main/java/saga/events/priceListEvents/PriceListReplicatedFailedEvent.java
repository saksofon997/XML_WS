...
public class PriceListReplicatedFailedEvent {
    ...
    public PriceListReplicatedFailedEvent() {}

    public PriceListReplicatedFailedEvent(String priceListAggregateId, Long priceListId, String reason, TypeOfCommand typeOfCommand) {
