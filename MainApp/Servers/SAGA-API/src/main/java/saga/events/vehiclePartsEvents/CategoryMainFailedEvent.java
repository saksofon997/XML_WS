...
public class CategoryMainFailedEvent {
    private String categoryAggregateId;
    private Long categoryId;
    private String reason;
    private TypeOfCommand typeOfCommand;

    public CategoryMainFailedEvent() {}

    public CategoryMainFailedEvent(String categoryAggregateId, Long categoryId, String reason, TypeOfCommand typeOfCommand) {
