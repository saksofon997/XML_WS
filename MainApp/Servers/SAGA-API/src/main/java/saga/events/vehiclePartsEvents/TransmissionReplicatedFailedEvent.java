...
public class TransmissionReplicatedFailedEvent {
    ...
    public TransmissionReplicatedFailedEvent() {}

    public TransmissionReplicatedFailedEvent(String transmissionAggregateId, Long transmissionId, String reason, TypeOfCommand typeOfCommand) {
