...
public class RentalReportMileageUpdateFailedEvent {
    private String newRentalReportAggregateId;

    private Long rentalReportId;
    private String reason;

    public RentalReportMileageUpdateFailedEvent() {
    }

    public RentalReportMileageUpdateFailedEvent(String newRentalReportAggregateId, Long rentalReportId, String reason) {
