...
public class RentalReservedFailedEvent {
    private String rentalReservedAggregateId;
    private Long rentalId;
    private String reason;

    public RentalReservedFailedEvent() {
    }

    public RentalReservedFailedEvent(String rentalReservedAggregateId, Long rentalId, String reason) {
