...
public class FuelMainFailedEvent {
    private String fuelAggregateId;
    private Long fuelId;
    private String reason;
    private TypeOfCommand typeOfCommand;

    public FuelMainFailedEvent() {}

    public FuelMainFailedEvent(String fuelAggregateId, Long fuelId, String reason, TypeOfCommand typeOfCommand) {
