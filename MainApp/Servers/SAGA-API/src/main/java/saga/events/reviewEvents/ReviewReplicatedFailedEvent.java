...
public class ReviewReplicatedFailedEvent {
    ...
    public ReviewReplicatedFailedEvent() {}

    public ReviewReplicatedFailedEvent(String reviewAggregateId, Long reviewId, Long vehicleId, String reason, TypeOfCommand typeOfCommand) {
